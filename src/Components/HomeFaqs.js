...
const HomeFaqs = () => {
    return (
        <div className='container mx-auto'>
            <h2 className='text-center font-semibold text-6xl my-16'>FAQs</h2>
            <div>
                {/* 1 */}
                <div tabindex="0" class="collapse collapse-plus border border-base-300 bg-base-100 rounded-box p-3 mt-5" >
                    <div class="collapse-title text-xl font-medium " >
                        <p className='font-semibold text-3xl'> How is NOZE different from other air quality monitors?</p>
                    </div>
                ...
                <div tabindex="0" class="collapse collapse-plus border border-base-300 bg-base-100 rounded-box p-3 mt-5">
                    <div class="collapse-title text-xl font-medium">
                        <p className='font-semibold text-3xl'> What is a digital nose?</p>
                    </div>
                    <div class="collapse-content">
                ...
                <div tabindex="0" class="collapse collapse-plus border border-base-300 bg-base-100 rounded-box p-3 mt-5">
                    <div class="collapse-title text-xl font-medium">
                        <p className='font-semibold text-3xl'> What is the Virus Risk Index?</p>
                    </div>
                    <div class="collapse-content">
                ...
                <div tabindex="0" class="collapse collapse-plus border border-base-300 bg-base-100 rounded-box p-3 my-5">
                    <div class="collapse-title text-xl font-medium">
                        <p className='font-semibold text-3xl'> How does the Virus Risk Index work?</p>
                    </div>
                    <div class="collapse-content">
                ...
                <div tabindex="0" class="collapse collapse-plus border border-base-300 bg-base-100 rounded-box p-3 mt-5">
                    <div class="collapse-title text-xl font-medium">
                        <p className='font-semibold text-3xl'> What space can it cover?</p>
                    </div>
                    <div class="collapse-content">
                ...
                <div tabindex="0" class="collapse collapse-plus border border-base-300 bg-base-100 rounded-box p-3 mt-5">
                    <div class="collapse-title text-xl font-medium">
                        <p className='font-semibold text-3xl'>How many NOZE devices do I need?</p>
                    </div>
                    <div class="collapse-content">
                ...
                <div tabindex="0" class="collapse collapse-plus border border-base-300 bg-base-100 rounded-box p-3 mt-5">
                    <div class="collapse-title text-xl font-medium">
                        <p className='font-semibold text-3xl'> What is the Warranty on NOZE?</p>
                    </div>
                    <div class="collapse-content">
